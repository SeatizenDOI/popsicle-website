...
export default function Page() {
    return (
        <div className="reglements mx-4 sm:mx-20">
            ...
            <p>
                Si un concurrent a manqué d’observer un quelconque des articles
                de ce règlement, il sera disqualifié.
            </p>

            <h2>Article 2 – Conditions de Participation aux Concours</h2>
            <p>
                Le championnat est réservé à tout participant pêcheur non
                professionnel et/ou non guide de pêche.
            </p>
            <p>
                Le nombre de participants est limité à 100 personnes. Une fiche
                d’inscription sera à remplir obligatoirement par le concurrent
                pour obtenir le droit de concourir.
            </p>
